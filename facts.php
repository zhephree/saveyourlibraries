...
?>
		<section class="red">
			<h1>#SaveYourLibraries Facts</h1>

			<h2>What is Proposition #2?</h2>
			<p>
				Proposition #2 is a measure on the December 5, 2020 ballot that would cut the New Orleans Public Library's budget by 40% for the next 20 years.
			</p>
			<p>
				Advocates for prop #2 claim that the measure would “renew” library funding and support early childhood education. But this simply isn’t true. The reality is that prop #2 cuts library funding, allocates a very small amount to early childhood funding, and creates a huge economic development slush fund. Libraries and early childhood education deserve better. 
			</p>
			<img src="/img/facts1.png" alt="CURRENT
			Library Funding: $19 million. 

			UNDER PROP 2 
			Early Childhood Education: $1.5 million
			Library Funding: $11.3 million
			Economic Development Slush Fund: $8.6 million" class="full-width">

			<h2>What exactly does proposition #2 do?</h2>
			<p>
			...
			<p>
				If proposition #2 were to pass, this particular millage would be eliminated. In its place, prop #2 would create a new “library and early childhood education” fund. This fund would receive a much smaller millage, with a rate of 0.987, or about $3.8 million in 2021.
			</p>
			<img src="/img/facts2.png" alt="CURRENT
			NOPL Direct Funding
			Millage #1: 2.58 (about $10.0 million)
			Millage #2: 2.33 (about $9.0 million)

			IF #2 PASSES
			NOPL Direct Funding
			Millage #2: 2.33 (about $9.0 million)
			''Library and Early Childhood Fund'': 0.987 (about $3.8 million)" class="full-width">

			<h2>Do the proposed millage reallocations lower taxes?</h2>
			<p>
				No. The three propositions on the December 5 ballot collectively keep current millage rates exactly the same.
			</p>

			<h2>So what’s wrong with proposition #2?</h2>
			<p>We feel there are several ways in which prop #2 works against our community interests.</p>

			<ul>
				<li>
					Prop #2 cuts about 40% of the New Orleans Public Library budget for the next 20 years. This represents a massive, disproportionate cut that would result in reduced services, personnel lay-offs and branch closures. New Orleans loves libraries and have voted for this funding repeatedly. Now is not the time to take resources away from underserved communities.
				</li>
				<li>
					The reduced funding doesn’t go directly to the library like the current millage. Instead, the money goes through a “library and early childhood education” fund. Voters do not have adequate information about how this fund would function. It is clear, however, that prop #2 stands to compromise the NOPL’s independence.
				</li>
				<li>
					Most of the millions of taxpayer dollars cut from the library system wind up in an economic development slush fund. Voters don’t have nearly enough information about this fund, and the lack of transparency and accountability should be worrying to all New Orleans citizens.
				</li>
				<li>
					Prop #2 creates a false choice between early childhood education and libraries. We’re all for the proposed $1.5 million for early childhood education, but NOT when $7.5 million is being cut from libraries, which support early childhood education in their own right. 
				</li>
			</ul>
			...
			<p>
				<strong>On December 5, we’re asking voters to continue funding their libraries and to vote NO on proposition #2.</strong>
			</p>

			<h2>Where does all the money cut from the libraries go?</h2>
			<p>
				Each of the three propositions on the December 5 ballot would create one new fund. Let’s take a look at the current millages in question, and how money would be allocated to each of these new funds.
			</p>
			<img src="/img/facts3.png" alt="CURRENT MILLAGE RATES
			Public Library (2.58)
			Housing Improvement (0.91)
			Traffic Control + Capital Improvements (2.33)

			PROPOSED MILLAGE RATES
			Library + Early Childhood Education (0.987)
			Housing and ''Economic Development'' Fund (2.213)
			Infrastructure & Maintenance Fund (2.619)" class="full-width">
			<p>
				There’s a lot happening in this image, but we want to point out the two biggest changes: the huge cut in library funding, and the giant new “economic development” fund.
			</p>
			<h2>How exactly would these funds work?</h2>
			<p>
			...
			<p>
				Advocates for proposition #2 say they have the best of intentions, and we believe them. But the unfortunate reality is that opaque funds like these seem to invariably open the door to shady, back-room dealings. New Orleanians are <a href="https://www.nola.com/news/courts/article_a4844062-22de-11eb-8ded-17190a5a85fa.html" target="_blank" rel="noopener">all too familiar</a> with the opportunistic predators who use private-public partnerships as a means to extract resources from our communities.
			</p>

			<h2>Would the NOPL lose its independence?</h2>
			<p>
			...
			<h2>How else would these cuts impact the library?</h2>
			<p>
			...
			<h2>What about the library’s rainy day fund?</h2>
			<p>
			...
			<h2>So what about funding early childhood education?</h2>
			<p>
			...
			<p>
				We’d like to see even stronger funding for early childhood education on future ballot measures, while continuing to fund our libraries.
			</p>
			<img src="/img/facts4.png" alt="''Every $5 the library is losing, early childhood education only gets $1. So we're devastating our library system to give pennies to early childhood education. It just makes no sense. We're doing five times the harm as we are good.'' -- Andrea Neighbors, Library Board Member" class="full-width">

			<h2>What happens if proposition #2 doesn’t pass?</h2>
			<p>
			...
			<h2>Is this hard to understand, or is it just me?</h2>
			<p>
			...
			<p>
				If we haven’t answered your question, please reach out to us at <a href="mailto:SaveYourNOLALibrary@gmail.com">SaveYourNOLALibrary@gmail.com</a>, or on our <a href="https://www.facebook.com/SaveYourNOLALibrary" target="_blank" rel="noopener">Facebook</a>, <a href="https://www.instagram.com/saveyournolalibrary/" target="_blank" rel="noopener">Instagram</a>, or <a href="https://twitter.com/savenolalibrary" target="_blank" rel="noopener">Twitter</a>.
			</p>
