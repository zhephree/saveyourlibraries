...
?>
		<section class="red">
			...
			<h2>Vote NO on #2</h2>
			<p>
				Proposition #2 threatens to gut the New Orleans Public Library system, cutting 40% of the NOPL budget for the next 20 years. There is no doubt that a 40% cut would mean reductions in library services, staff layoffs, and branches closing.
			</p>
			<p>
				For every $5 cut from the library, only $1 goes toward early childhood education. Meanwhile, millions of taxpayer dollars are funneled into an “economic development” slush fund. 
			</p>
			<p>
